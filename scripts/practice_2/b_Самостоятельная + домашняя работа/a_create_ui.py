...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        self.lineEditPassword.setEchoMode(self.lineEditPassword.EchoMode.Password)   # TODO установите ограничение видимости вводимых знаков с помощью метода .setEchoMode()
