...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.activated.connect(lambda: self.plainTextEditLog.setPlainText(self.comboBox.currentText()))  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
